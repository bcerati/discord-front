...
import ServerCategory from "./category/ServerCategory";

interface IServerCategoriesProps {
  serverId: string;
}

export default function ServerCategories({ serverId }: IServerCategoriesProps) {
