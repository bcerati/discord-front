    ...
    <div className="flex flex-col flex-1 shrink min-w-0 bg-gray-700">
      <div className="flex items-center px-2 h-12 shadow-sm">
        <div className="flex items-center">
          <svg
            viewBox="0 0 24 24"
            className="mx-2 w-6 h-6 font-semibold text-gray-400"
          >
            <title>Hashtag</title>
            <path
              fill="currentColor"
      ...
      <div className="overflow-y-scroll flex-1">
          ...
          <div className="flex py-0.5 pr-16 pl-4 mt-[17px] leading-[22px] hover:bg-gray-950/[.07]">
            ...
            <div>
              <p className="flex items-baseline">
                <span className="mr-2 font-medium text-green-400">Wilmer6</span>
                <span className="text-xs font-medium text-gray-400">
                  03/28/2022
                </span>
              </p>
              <p className="text-gray-100">
                Voluptates unde velit explicabo accusantium exercitationem.
                Molestiae et similique illo blanditiis et facere rem quod. Ab
                esse impedit aliquam quo vel dolorem.
              </p>
            </div>
          </div>
        </div>
        <div>
          <div className="flex py-0.5 pr-16 pl-4 mt-[17px] leading-[22px] hover:bg-gray-950/[.07]">
            ...
            <div>
              ...
              <p className="text-gray-100">
                Consectetur nam corrupti. Quas optio ea odio sit odio quae
                voluptas id error. Dicta aut qui qui vel.
              </p>
            </div>
          </div>
        </div>
        <div>
          <div className="py-0.5 pr-16 pl-4 leading-[22px] hover:bg-gray-950/[.07]">
            <p className="pl-14 text-gray-100">
              Molestiae inventore placeat nesciunt. Laboriosam facere odio
              beatae nobis vero quia. Et voluptates molestiae magni beatae vitae
              atque eos optio.
            </p>
          </div>
        </div>
